...
This is a monorepo boilerplate for building full-stack applications with a Next.js web app and Expo React Native mobile app. It includes authentication, shared business logic, and database integration out of the box.
